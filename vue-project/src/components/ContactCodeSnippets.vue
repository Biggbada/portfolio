...
<template>
  <div id="contact-form-displayer" class="item-column bordered">
    ...
    ><span class="pink"> =</span> { <span class="violet">name</span>:
      <span class="orange"> {{ store.contactForm.name }}</span>,<span class="violet"> email</span>:
      <span class="orange"> {{ store.contactForm.email }}</span>, <span class="violet">message</span>:
      <span class="orange"> {{ store.contactForm.message }}</span>, date: <span class="orange"> "Thu 21 Apr"</span> }<br />
